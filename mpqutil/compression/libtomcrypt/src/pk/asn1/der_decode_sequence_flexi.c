   ...
   while (*inlen) {     
      ...
      switch (type) {
         ...
         case 0x03: /* BIT */
            ...
            if ((l->data = calloc(1, l->size)) == NULL) {
               err = CRYPT_MEM;
               goto error;
            }
         ...
         case 0x06: /* OID */
            ...
            if ((l->data = calloc(len, sizeof(unsigned long))) == NULL) {
               err = CRYPT_MEM;
               goto error;
            }
            ...
            if ((realloc_tmp = realloc(l->data, l->size * sizeof(unsigned long))) == NULL) {
         ...
         case 0x0C: /* UTF8 */
            ...
            if ((l->data = calloc(sizeof(wchar_t), l->size)) == NULL) {
               err = CRYPT_MEM;
               goto error;
            }
         ...
         case 0x17: /* UTC TIME */
            ...
            if ((l->data = calloc(1, sizeof(ltc_utctime))) == NULL) {
               err = CRYPT_MEM;
               goto error;
            }
